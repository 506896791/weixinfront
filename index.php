 ...
 */
include 'my/WexinMsgHelper.php';
include 'my/LogHelper.php';
...
//        }
	...
	if (!empty($postStr)){
                ...
                {
                    $this->responseImageMsg($fromUsername, $toUsername, $postObj->PicUrl, $logger);
                }
    ...
    private function responseImageMsg($fromUsername,$toUsername,$PicUrl,$logger)
    {
        ...
        $logger->write_log($api_url);
        $pic_json = $this->file_get_content($api_url);
        $logger->write_log($pic_json);
    ...
    private function get_response_auto($keyword)
    {
        ...
        $result = $this->file_get_content('http://dev.skjqr.com/api/weixin.php?email=506896791@qq.com&appkey=94782c7658436c20b25bdcd6e0da5117&msg='.$keyword);
